export default function MiddlePanel(){
    ...
    return(
        <div className=" w-1/2 h-5/6">
            ...
            <h1 className="m-2 mt-4 text-5xl text-center font-serif font-bold">La Asesina de los Famosos: Beyoncé</h1>
            ...
            <div className="flex flex-row justify-center">
                <p className="text-xs mb-3 font-serif">Beyoncé es una asesina</p>
            </div>
            ...
            <p className="text-justify font-serif">¡Qué estremecedor! ¡Beyoncé Giselle Knowles está siendo investigada
                ...
                Entonces, ¿por qué no sería un asesino? Esta convicción empezó el artículo en que Jay Z y Combs están
            ...
            <br/>
            <p className="text-justify font-serif">Aaliyah era una artista de R&B muy talentosa y solo tenía 21 años
                cuando murió en un choque de avión en las Bahamas. Murió el 25 de agosto de 2001. Left Eye también era
                una artista de R&B y murió el 25 de abril de 2002 en un choque de coche. Michael Jackson era un artista
                quién no necesita introducción y quien desafortunadamente murió el 25 de junio de 2009.
            ...
            <div className="flex flex-row justify-center">
                <img src={"/lefteye-MJ-aaliyah.jpg"} alt="Las Victimas" className="mt-3 h-auto w-1/2 rounded-md"></img>
            </div>
            <div className="flex flex-row justify-center">
                <p className="text-xs text-center mb-3 font-serif">Left Eye, Michael Jackson, y Aaliyah tenían
                    muchas <br/> promesas para el futuro antes de morir.</p>
            </div>

            <br/><br/>


            <h1 className="m-2 text-2xl font-serif ">Ella lo sabe</h1>
            <br/>
            <p className="text-justify font-serif">La canción “She Knows” de J Cole es sobre la tentación de la fama e
                infidelidad. Pero, también tiene un verso que dice “Rest in peace to Aaliyah / Rest in peace to Left Eye
                / Michael Jackson, I&aposll see ya / Just as soon as I die” que ahora se ha relacionado con sus asesinatos,
